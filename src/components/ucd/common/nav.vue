<template>
  ...
  <q-layout :view='view' style="overflow: hidden" class="navTop nav-top-white" position="top">
    <q-tabs slot="navigation" class="q-tabs-logo"  >
      <q-tab slot="title" hide="label" class="logo">
         <img src="statics/images/Homepage/ico_menu_white.png" class="responsive" >
    ...
    <q-tabs slot="navigation" class="q-tabs-left">
        <q-route-tab slot="title" default="true" to="/Home" inline hide="icon"><i :class="[isHover==true?'blackBottom':'blackBottom-white']"></i></q-route-tab>
    </q-tabs>
